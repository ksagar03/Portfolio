...
const Skill = ({ name, x, y }) => {
  ...
  return (
    <motion.div
      className=" flex items-center justify-center rounded-full font-semibold bg-dark text-light py-3 px-6 shadow-dark shadow-sm cursor-default absolute dark:text-dark dark:shadow-light dark:bg-light  lg:py-2 lg:px-4 md:text-sm md:py-1.5 md:px-2.5  xs:bg-transparent xs:dark:bg-transparent xs:text-dark xs:dark:text-light xs:font-bold xs:shadow-none xs:dark:shadow-none"
...
const Skills = () => {
  return (
    ...
    "
      >
        <motion.div
          className=" flex items-center justify-center rounded-full font-semibold bg-dark text-light p-8 shadow-dark shadow-sm cursor-pointer dark:bg-light dark:text-dark  lg:p-6 md:p-4 sm:p-3 xs:p-2 xs:text-xs "
